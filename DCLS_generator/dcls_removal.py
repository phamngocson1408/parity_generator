...
from DCLS_generator.instanceModifier.modify_instance import remove_dcls_signal, remove_dcls_port
from DCLS_generator.moduleCreator.declare_port import declare_dcls_port_2001, declare_dcls_port_1995
...
if __name__ == "__main__":
    ...
    # INFO_path = './DCLS_generator/[INFO]_DCLS_TEMPLATE.xlsx'
    if args.info:
        INFO_path = args.info
    else:
